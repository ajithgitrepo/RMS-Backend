        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('Planogram Check')); ?></h4>
              </div>
          ...
          <!--  <div class="card-header card-header-text card-header-warning">
            ...
            <center>
              ...
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
               ...
               <form method="post" action="<?php echo e(route('update_product_Planogram_Check')); ?>" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <table id="datatables" class="table table-striped table-no-bordered table-hover" style="display:none">
                    ...
                    <thead class="text-primary">
                      ...
                      <th>
                          <?php echo e(__('Before_Image')); ?>

                      </th>
                     
                      <th>
                          <?php echo e(__('After_Image')); ?>
                     ...
                     <tr> 
                         ...
                         <!--  <td class="sorting_1">
                            <div class="avatar avatar-sm rounded-circle img-circle" style="width:100px; height:100px;overflow: hidden;">
                                <?php if($product->planogram_img != ""): ?>
                                <img src="/planogram_image/<?php echo e($product->planogram_img); ?>" onclick="DoSomething(this.src);" alt="" style="max-width: 100px;">
                                <?php else: ?> 
                         ...
                         <a href=""  id="<?php echo e($product->c_id); ?>"  class="bleu"  title="" > <?php echo e($product->category_name); ?> </a>  

                            <input type="checkbox" checked
                              id="<?php echo e($i); ?>"   style="display:none"   plano_image="<?php echo e($product->planogram_img); ?>"
                              outlet_products_mapping_id="<?php echo e($product->opm); ?>"  category_id="<?php echo e($product->c_id); ?>"
                              timesheet_id="<?php echo e($product->id); ?>" 
                              journy_date="<?php echo e($product->date); ?>"
                              category_name="<?php echo e($product->category_name); ?>"
                              default_image="<?php echo e($product->planogram_img); ?>"
                          ...
                          <td> 
                           ...
                           <input type="file" class="secondfile"  name="uploadfile[]" accept="image/*" id="file<?php echo e($k); ?>" ></input>
                            ...
                            <td>
                                        <!-- Pending -->  
                         <?php if(($product->before_image == null && $product->after_image == null )): ?>
                       <a href="javascript:void(0)"  id="<?php echo e($product->planlo_id); ?>" rel="tooltip" data-original-title="Planogram Check"  class=""  title="" > Pending </a>
                             <?php else: ?>
                       <a href="javascript:void(0)"  id="<?php echo e($product->planlo_id); ?>" rel="tooltip" data-original-title="Planogram Check"  class="palnoview"  title="" > view </a>
                             <?php endif; ?>
                  ...
                  <button id="submit" disabled  type="submit" class="btn btn-rose float-right"><?php echo e(__('Submit')); ?></button>
                  </form>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'journey-plan', 'menuParent' => 'Journey-Plan', 'titlePage' => __('Customer Activity')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thethethoughtfactory/Desktop/RMS-2-11-21/resources/views/planogram_checks/index.blade.php ENDPATH**/ ?>