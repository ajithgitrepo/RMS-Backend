        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('Report')); ?></h4>
              </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                   <select class="form-control js-select2" data-style="select-with-transition"  title="Select Merchandiser" data-size="7" name="merchandiser" id="input_merchandiser" 
                    ...
                    <?php $__currentLoopData = $merchandisers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merchant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <option value="<?php echo e($merchant->employee_id); ?>"> <?php echo e($merchant->first_name); ?> <?php echo e($merchant->surname); ?> - <?php echo e($merchant->employee_id); ?> </option>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'field_outlet_report', 'menuParent' => 'Field_Manager_Report', 'titlePage' => __('Outlet Report')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thethethoughtfactory/Desktop/RMS-2-11-21/resources/views/field_manager_outlet_report/report/index.blade.php ENDPATH**/ ?>