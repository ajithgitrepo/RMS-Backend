        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('Date JourneyPlan')); ?></h4>
              </div>
                      ...
                      <thead class="text-primary">
                        ...
                        <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="parent">
                              ...
                              <!-- <td>
                               <?php echo e($parent->outlet->outlet_lat); ?>

                              </td>
                              <td>
                                <?php echo e($parent->outlet->outlet_long); ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <form method="get" action="<?php echo e(url('filter_merchant_timesheet')); ?>" class="form-inline" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'date-timesheet', 'menuParent' => 'Timesheet', 'titlePage' => __('Date JourneyPlan')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thethethoughtfactory/Desktop/RMS-2-11-21/resources/views/merchant_timesheet/index.blade.php ENDPATH**/ ?>