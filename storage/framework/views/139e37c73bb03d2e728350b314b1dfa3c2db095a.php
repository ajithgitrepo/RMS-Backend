        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('Product Visibility')); ?></h4>
              </div>
         ...
         <!--   <div class="card-header card-header-text card-header-warning">
            ...
            <?php $__currentLoopData = $Store_result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $str): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <center>
                <h4 class="card-title">  [<?php echo e($str->store_code); ?>] <?php echo e($str->store_name); ?></h4>
                <p class="card-category"><?php echo e($str->contact_number); ?> - <?php echo e($str->address); ?>  </p>
                </center>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
            </div>
          </div> -->
    
            <!-- <?php echo e(route('update_product_visibility')); ?> -->
         
               <div class="table-responsive">
               <form method="post" action="<?php echo e(route('update_product_visibility')); ?> " autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                     ...
                     <tr> 
                          ...
                          <td>
                           ...
                           <div class="togglebutton">
                              ...
                              <?php if( $product->is_available == "1" || $product->is_available == "is_available" || $product->is_available == null): ?> 
                              <!-- <input type="hidden" name="<?php echo e($i); ?>" value="0"> -->
                                <input type="checkbox" checked
                               
                                 id="<?php echo e($i); ?>"  
                               
                                outlet_products_mapping_id="<?php echo e($product->opm); ?>"  
                                timesheet_id="<?php echo e($product->id); ?>" 
                                journy_date="<?php echo e($product->date); ?>"
                                category_name="<?php echo e($product->category_name); ?>"
                                category_id="<?php echo e($product->c_id); ?>"
                                outlet_id="<?php echo e($product->outlet_id); ?>" class="checkbox" >
                        ...
                        <?php if( $product->is_available == "0"): ?> 
                           ...
                           <select name="reason" style="width:200px;" id="select<?php echo e($i); ?>" class="form-control text">
                           <option value="Out Of Stock" <?php if( $product->reason  == 'Out Of Stock'): ?> ? selected : null <?php endif; ?>>Out Of Stock</option>
                           <option value="Expired" <?php if( $product->reason  == 'Expired'): ?> ? selected : null <?php endif; ?>>Expired</option>
                           
                               <!-- <option value="Out Of Stock" >Out Of Stock</option>
                               <option value="Expired">Expired</option> -->
                           </select>
                           <input type="file" style="display:none;"  name="uploadfile[]" accept="image/*" id="file<?php echo e($k); ?>" ></input>
                           <?php endif; ?>
                           <?php if( $product->is_available == "1" ||  $product->is_available == "is_available" || $product->is_available == null): ?> 
                           <select name="reason"  value="<?php echo e(old('reason')); ?>"  style="width:200px;display:none;" id="select<?php echo e($i); ?>" class="form-control text">
                               <option value="" selected="">Reason</option>
                               <option value="Out Of Stock" >Out Of Stock</option>
                               <option value="Expired">Expired</option>
                           </select>
                           <input type="file"   name="uploadfile[]" accept="image/*" id="file<?php echo e($k); ?>" ></input>
                          ...
                          <td>
                            ...
                            <div class="form-container">
                              ...
                              <div class="dynamic-stuff">
                                ...
                                <?php if(isset($product->g_area)): ?>

                                <?php $__currentLoopData = $arr_g_area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $g_area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <div class="form-group dynamic-element">
                                      <div class="row">
                                         <div class="col-md-3">
                                              
                                              <input type="text" name="g_area[]" class="form-control g_area" placeholder=" G Area" value="<?php echo e($g_area); ?>" required>

                                         </div>
                                         
                                         <div class="col-md-3">

                                            <input type="text" name="main_aisle[]" class="form-control main_aisle" placeholder=" Main Aisle" value="<?php echo e($arr_m_aisle[$key]); ?>" required>

                                          </div>
                                          <div class="col-md-3">
                                           
                                            <input type="text" name="pois[]" class="form-control pois" placeholder=" POIs" value="<?php echo e($arr_pois[$key]); ?>" required>
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <?php endif; ?>
                                    <?php if( $product->is_available == "is_available"): ?> 
                                      <p class="add-one" >+ Add</p>
                                    <?php endif; ?>
                                  </div>
                          ...
                          <td class="sorting_1">
                            <!-- <div class="avatar avatar-sm img-circle" style="width:70px; height:50px;overflow: hidden;">
                               ...
                               <?php if( $product->category_name == ""): ?>
                                <img id="img<?php echo e($k); ?>"  onclick="DoSomething(this.src);" alt="" style="max-width: 70px;">
                                <?php else: ?>
                                <img id="img<?php echo e($k); ?>" src="/visibility_image/<?php echo e($product->image_url); ?>"  onclick="DoSomething(this.src);" alt="" style="max-width: 70px;">
                                <?php endif; ?>
                            </div> -->
...
//     $.ajax({
//         url: '<?php echo e(url('/update_product_availability')); ?>',
//         type: 'POST',              
//         data: formData,
...
<?php echo $__env->make('layouts.app', ['activePage' => 'journey-plan', 'menuParent' => 'Journey-Plan', 'titlePage' => __('Customer Activity')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thethethoughtfactory/Desktop/RMS-2-11-21/resources/views/visibility/index.blade.php ENDPATH**/ ?>