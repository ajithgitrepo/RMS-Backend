...
class stock_report extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'stock_report:stock_report';
    ...
    public function handle()
    {
         ...
         for($i=0;$i<=6; $i++)
         {
             if ($i==0)
             {
                 ...
                 $sheet->setCellValue('B1', date('d-m-Y',strtotime( $date)));
             ...
             if($i==1)
             {
                 ...
                 $sheet1->setCellValue('B1', date('d-m-Y',strtotime( $date)));
             ...
             if ($i==2)
             {
                 ...
                 $sheet2->setCellValue('B1', date('d-m-Y',strtotime( $date)));
             ...
             if ($i==3)
             {
                 ...
                 $sheet3->setCellValue('B1', date('d-m-Y',strtotime( $date)));
...
//                     $sheet3->setCellValue('E' . $rows, $avail->product_name );
             ...
             if ($i==4)
             {
                 ...
                 $sheet4->setCellValue('B1', date('d-m-Y',strtotime( $date)));
             ...
             if ($i==5)
             {
                 ...
                 $sheet5->setCellValue('A1','Date');
                 $sheet5->setCellValue('B1', date('d-m-Y',strtotime( $date)));
...
//                 \Log::info($availability);
                 ...
                 $sheet6->setCellValue('A1','Date');
                 $sheet6->setCellValue('B1', date('d-m-Y',strtotime( $date)));
                 ...
                 $fileName = "Stock_Report".$date.'-'.$time.'.'.$type;
                 ...
                 $writer->save("approval_files/stock_report/".$fileName);

                 //\Log::info($files);


                 $url ="approval_files/stock_report/" .$fileName;
...
//                 array_push($files,$url);
                 ...
                 Mail::send('timesheet.dailystock',$data, function($message) use($url)
                 {
