...
class weekly_stock extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'weekly_stock:weekly_stock';
...
//                 $spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::createReader("Xlsx");
                ...
                $sheet->setCellValue('B1', date('d-m-Y',strtotime( $start_week)));

                $sheet->setCellValue('C1','To');
                $sheet->setCellValue('D1', date('d-m-Y',strtotime( $end_week)));


//                \Log::info($sheet->setCellValue('A1', date('F', strtotime($start))));
                $sheet->setCellValue('G1', 'Availability');
...
//                    ->whereDate('date', $date)
                ...
                $sheet1->setCellValue('A1','From');
                $sheet1->setCellValue('B1',date('d-m-Y',strtotime( $start_week)));

                $sheet1->setCellValue('C1','To');
                $sheet1->setCellValue('D1',date('d-m-Y',strtotime( $end_week)));
                $sheet1->setCellValue('F1', 'Visibility');
...
//                 \Log::info($availability);
                ...
                $sheet2->setCellValue('A1','From');
                $sheet2->setCellValue('B1',date('d-m-Y',strtotime( $start_week)));

                $sheet2->setCellValue('C1','To');
                $sheet2->setCellValue('D1',date('d-m-Y',strtotime( $end_week)));
                $sheet2->setCellValue('F1', 'Share Of Shelf');
...
//                    ->whereDate('promotion_check.created_at', $date)
                    ->whereBetween('promotion_check.created_at',[$start_week, $end_week])
...
//                 \Log::info($promotion_check);
                ...
                $sheet3->setCellValue('A1','From');
                $sheet3->setCellValue('B1',date('d-m-Y',strtotime( $start_week)));

                $sheet3->setCellValue('C1','To');
                $sheet3->setCellValue('D1',date('d-m-Y',strtotime( $end_week)));
                $sheet3->setCellValue('F1', 'Promotion Check');
...
//                 \Log::info($availability);
                ...
                $sheet4->setCellValue('A1','From');
                $sheet4->setCellValue('B1',date('d-m-Y',strtotime( $start_week)));

                $sheet4->setCellValue('C1','To');
                $sheet4->setCellValue('D1',date('d-m-Y',strtotime( $end_week)));
                $sheet4->setCellValue('F1', 'Planogram ');
...
//                    ->whereDate('competitor.created_at', $date)
                    ->whereBetween('competitor.created_at', [$start_week, $end_week])
...
//                 $spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::createReader("Xlsx");
                ...
                $sheet5->setCellValue('A1','From');
                $sheet5->setCellValue('B1',date('d-m-Y',strtotime( $start_week)));

                $sheet5->setCellValue('C1','To');
                $sheet5->setCellValue('D1',date('d-m-Y',strtotime( $end_week)));
                $sheet5->setCellValue('G1', 'Competitor Info');
...
//                $sheet5->setCellValue('H3', 'Category Name');
                ...
                $sheet5->setCellValue('J3', 'Regular Price');
...
//                 \Log::info($availability);
                ...
                $sheet6->setCellValue('A1','From');
                $sheet6->setCellValue('B1',date('d-m-Y',strtotime( $start_week)));

                $sheet6->setCellValue('C1','To');
                $sheet6->setCellValue('D1',date('d-m-Y',strtotime( $end_week)));
                $sheet6->setCellValue('G1', 'Outlet Stock Expiry Report');
                ...
                $fileName = "Weekly_Stock_Report" . $date . '-' . $time . '.' . $type;
                ...
                $writer->save("approval_files/weekly/" . $fileName);

                //\Log::info($files);


                $url = "approval_files/weekly/" . $fileName;

                \Log::info($url);

                $data = array('first_name'=>'' ,'surname' => '');
                Mail::send('timesheet.weekly',$data, function($message) use($url)
                {
                    $message->to('arun@rhapsody.ae');
                    //$message->cc('ramananv@rhapsody.ae');
                    $message->subject('Weekly Stock Report');
