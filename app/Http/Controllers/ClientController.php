...
class ClientController extends Controller
{
    public function index(Employee $model)
    {
        ...
        $matchThese = ['is_active' => '1','designation' => '7'];
     ...
     // $results=Employee::where($matchThese)->with('documents')->get();
      ...
      $result = $model->with('Role')->where($matchThese)->get();
        ...
        return view('client.index', ['employee' => $result]);
    }
    ...
    public function store(Request $request, Employee $model)
    {
      ...
      //  dd($request->nationality);    
        ...
        return redirect()->route('client.index')->withStatus(__('Client details successfully created'));
    }
    ...
    {   
        ...
        return view('client.edit',['employee' => $results,'roles' => $roles]);
    }
    ...
    {   
        ...
        $validatedData = $request->validate([
           ...
           // 'email' => 'required|email|unique:employee',
            ...
            return redirect()->route('client.index')->withStatus(__('client details successfully updated'));
    }
