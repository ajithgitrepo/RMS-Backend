                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('leave_type') ? ' has-danger' : '' }}">
                      ...
                      <select class="form-control{{ $errors->has('leave_type') ? ' is-invalid' : '' }} js-select2" name="employee_id" id="employee_id" 
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('rule') ? ' has-danger' : '' }}">
                     ...
                     value="{{ old('rule') }}" aria-required="true">
                        <option value=" ">Select</option>
					    @foreach($non_merchant as $merchant)
						<option value="{{ $merchant->employee_id }}">{{ $merchant->first_name }} {{ $merchant->middle_name }} {{ $merchant->surname }} ({{ $merchant->employee_id }}) </option>
						@endforeach
                  		</select>
