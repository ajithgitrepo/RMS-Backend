...
@extends('layouts.app', ['activePage' => 'employee-documents', 'menuParent' => 'Employee', 'titlePage' => __('Employee Documents')])
                    ...
                    <tbody>
                      ...
                      @foreach($documents as $doc)
                        ...
                        <tr>
                          ...
                          <td>
                            {{ $doc->employees->first_name.' '.$doc->middle_name }}
                          </td>
                          <td>
                            {{ $doc->employees->designation }}
                          </td>
                          <td>
                          ...
                          <td class="display-block">
                              <form action="" method="post">
                                       ...
                                       <!--  <a rel="tooltip" class="btn btn-info btn-action btn-link view-edit" data-toggle="modal" data-target="#exampleModal" data-original-title="" title="" onclick="view_employee({{$doc->id}})" >
                                            <i class="fa fa-eye" aria-hidden="true">view</i>
                                            <div class="ripple-container"></div>
                                          </a> -->

                                          <a rel="tooltip" class="btn btn-success btn-action btn-link view-edit" href="" data-original-title="" title="">
                                            <i class="material-icons">edit</i>
                                            <div class="ripple-container"></div>
                                          </a>
                                      
                                          <button type="button" class="btn btn-danger btn-link view-edit" data-original-title="" title="" onclick="confirm('{{ __("Are you sure you want to delete this employee?") }}') ? this.parentElement.submit() : ''">
