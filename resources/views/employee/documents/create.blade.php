...
<div class="content">
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">  
                        <div class="form-group">
                          ...
                          <input  class="form-control" name="emirate_id" id="emirate_id" type="input" value="{{old('emirate_id',$documents[0]->emirates_id) }}" required data-parsley-required-message="Please enter emirates id"/>
 ...
 -->
                <button type="submit"  class="btn btn-finish btn-fill btn-rose btn-wd" name="finish" value="Finish">{{ __('Add Documents') }}</button>
