...
@extends('layouts.app', ['activePage' => 'employee', 'menuParent' => 'Employee', 'titlePage' => __('Add Employee')])
...
<div class="content">
    ...
    <div class="col-md-12 col-12 mr-auto ml-auto">
      ...
      <div class="wizard-container">
        <div class="card card-wizard" data-color="rose" id="wizardProfile">
           <form method="post" enctype="multipart/form-data" action="{{ route('employee.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="employee_id" value="{{ old('employee_id') }}" required>
                   ...
                   <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="first_name" value="{{ old('first_name') }}" required>
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="middle_name" value="{{ old('middle_name') }}" >
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="surname" value="{{ old('surname') }}" required>
                      ...
                      <div class="input-group form-control-sm">
                        ...
                        <div class="form-group">
                         ...
                         <select name="codes" id="codes" value="{{ old('codes') }}" required>
                		    ...
                		    <input class="mobile_number" placeholder="Phone" value="{{ old('mobile_number') }}" type=text name="mobile_number" required="" />
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="emirates_id" name="emirates_id" value="{{ old('emirates_id') }}" required>
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                         ...
                         <!--  <input type="text" class="form-control" id="" name="designation" value="{{ old('designation') }}" required>-->

                     <select class="bmd-label-floating form-control{{ $errors->has('leavetype') ? ' is-invalid' : '' }}" name="designation" id="input-designation" 
                     ...
                     <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="department" value="{{ old('department') }}" required>
                     ...
                     <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" id="" name="joining_date" value="{{ old('joining_date') }}" required >
                   ...
                   <!--  <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="employee_score" value="{{ old('employee_score') }}" >
                           @include('alerts.feedback', ['field' => 'employee_score'])
                        </div>
                      </div>
                    </div>
 -->
                      ...
                      <div class="col-lg-10 mt-3">
                         <div class="input-group form-control-lg">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" name="passport_number" value="{{ old('passport_number') }}" required>
					   ...
					   <div class="col-lg-10 mt-3">
                         <div class="input-group form-control-lg">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="" name="passport_exp_date" value="{{ old('passport_exp_date') }}" required>
                        ...
                        <div class="col-lg-10 mt-3">
                         <div class="input-group form-control-lg">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="" name="visa_exp_date" value="{{ old('visa_exp_date') }}" required>
                        ...
                        <div class="col-lg-10 mt-3">
                         <div class="input-group form-control-lg">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="" name="medical_ins_no" value="{{ old('medical_ins_no') }}" >
                        ...
                        <div class="col-lg-10 mt-3">
                         <div class="input-group form-control-lg">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="" name="medical_ins_exp_date" value="{{ old('medical_ins_exp_date') }}" >
                          </div>
                         </div>
                       </div>
                        ...
                        <div class="col-lg-10 mt-3">
                         <div class="input-group form-control-lg">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" name="visa_company_name" value="{{ old('visa_company_name') }}" required>
 ...
 -->
                <button type="submit"  class="btn btn-finish btn-fill btn-rose btn-wd" name="finish" value="Finish">{{ __('Add Employee') }}</button>
            ...
            <div class="card ">
              ...
              <div class="card-body ">
               ...
               <!--  <div class="row">
                 ...
                 <!-- <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('employee_id') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('employee_id') ? ' is-invalid' : '' }}" name="employee_id" id="input-employee_id" type="text" placeholder="{{ __('Employee ID') }}" value="{{ old('employee_id') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'employee_id'])
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('first_name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" id="input-name" type="text" placeholder="{{ __('First Name') }}" value="{{ old('first_name') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'first_name'])
                    </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('middle_name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" name="middle_name" id="input-name" type="text" placeholder="{{ __('Middle Name') }}" value="{{ old('middle_name') }}"  aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('surname') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" name="surname" id="input-name" type="text" placeholder="{{ __('Surname') }}" value="{{ old('surname') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'surname'])
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Passport Number') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('passport_number') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('passport_number') ? ' is-invalid' : '' }}" name="passport_number" id="input-name" type="text" placeholder="{{ __('Passport Number') }}" value="{{ old('passport_number') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'passport_number'])
                    </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('nationality') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nationality') ? ' is-invalid' : '' }}" name="nationality" id="input-name" type="text" placeholder="{{ __('Nationality') }}" value="{{ old('nationality') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'nationality'])
                    </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('mobile_number') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('mobile_number') ? ' is-invalid' : '' }}" name="mobile_number" id="input-name" type="text" placeholder="{{ __('Mobile Number') }}" value="{{ old('mobile_number') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'mobile_number'])
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('designation') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('designation') ? ' is-invalid' : '' }}" name="designation" id="input-phone" type="text" placeholder="{{ __('Designation') }}" value="{{ old('designation') }}" aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'designation'])
                    </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('department') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('department') ? ' is-invalid' : '' }}" name="department" id="input-phone" type="text" placeholder="{{ __('Department') }}" value="{{ old('department') }}" aria-required="true"/>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('joining_date') ? ' has-danger' : '' }}">
                      <input class="form-control datepicker{{ $errors->has('joining_date') ? ' is-invalid' : '' }}" name="joining_date" id="input-joining_date" type="text" placeholder="{{ __('Joining Date') }}" value="{{ old('joining_date') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'joining_date'])
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Visa Expiry Date') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('visa_exp_date') ? ' has-danger' : '' }}">
                      <input class="form-control datepicker{{ $errors->has('visa_exp_date') ? ' is-invalid' : '' }}" name="visa_exp_date" id="input-visa_exp_date" type="text" placeholder="{{ __('Visa Expiry Date') }}" value="{{ old('visa_exp_date') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'visa_exp_date'])
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Passport Expiry Date') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('passport_exp_date') ? ' has-danger' : '' }}">
                      <input class="form-control datepicker{{ $errors->has('passport_exp_date') ? ' is-invalid' : '' }}" name="passport_exp_date" id="input-passport_exp_date" type="text" placeholder="{{ __('Passport Expiry Date') }}" value="{{ old('passport_exp_date') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'passport_exp_date'])
                    </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Medical Insurance No.') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('medical_ins_no') ? ' has-danger' : '' }}">
                      <input class="form-control {{ $errors->has('medical_ins_no') ? ' is-invalid' : '' }}" name="medical_ins_no" id="input-medical_ins_no" type="text" placeholder="{{ __('Medical Insurance No.') }}" value="{{ old('medical_ins_no') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'medical_ins_no'])
                    </div>
                  </div>
                </div>

                 <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Medical Insurance Expiry Date') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('medical_ins_exp_date') ? ' has-danger' : '' }}">
                      <input class="form-control datepicker {{ $errors->has('medical_ins_exp_date') ? ' is-invalid' : '' }}" name="medical_ins_exp_date" id="input-medical_ins_exp_date" type="text" placeholder="{{ __('Medical Insurance Expiry Date') }}" value="{{ old('medical_ins_exp_date') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'medical_ins_exp_date'])
                    </div>
                  </div>
                </div>

                 <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Visa Company Name') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('visa_company_name') ? ' has-danger' : '' }}">
                      <input class="form-control {{ $errors->has('visa_company_name') ? ' is-invalid' : '' }}" name="visa_company_name" id="input-visa_company_name" type="text" placeholder="{{ __('Visa Company Name') }}" value="{{ old('visa_company_name') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'visa_company_name'])
                    </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Employee Score') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('employee_score') ? ' has-danger' : '' }}">
                      <input class="form-control {{ $errors->has('employee_score') ? ' is-invalid' : '' }}" name="employee_score" id="input-employee_score" type="text" placeholder="{{ __('Employee Score') }}" value="{{ old('employee_score') }}"  aria-required="true"/>
                      @include('alerts.feedback', ['field' => 'employee_score'])
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-rose">{{ __('Add Employee') }}</button>
              </div>
            </div>
          </form>
        </div>
