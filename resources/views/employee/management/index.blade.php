                ...
                @canany(['isHuman_Resource','isAdmin','isTopManagement'],App\User::class)
                  <div class="row">
                    <div class="col-12 text-right">
                       <a class="btn btn-sm btn-warning" style="color: #fff;" data-toggle="modal" data-target="#modelWindow" >{{ __('Filter') }}</a>  <br>
                      <a href="{{ route('employee.create') }}" class="btn btn-sm btn-rose">{{ __('Add Employee') }}</a>
                    </div>
                  </div>
                @endcan
                        ...
                        <tr>
                          ...
                          <td class="td-actions">
                           @if($emp->documents->count() <= 0)
                                 ...
                                 <a  href="{{ url('add_documents',$emp) }}" class="btn btn-success" title="Add">
                           ...
                           @if($emp->documents->count() > 0)
                            ...
                            <a   data-toggle="modal" data-target="#documentModal" class="btn btn-info" onclick="view_documents('{{$emp->employee_id}}')" title="View">
                                          <i class="material-icons">visibility</i>
                                        </a> 

                             <a  href="{{ route('update_documents',$emp) }}" class="btn btn-warning" title="Edit">
                             ...
                             <!--   <a rel="tooltip" class="btn btn-info btn-action btn-link view-edit" data-toggle="modal" 
                                  ...
                                  onclick="view_documentsfields('{{$emp->employee_id}}')" >
                          ...
                          <td class=" td-actions display-block">
                              <form action="{{ route('employee.destroy', $emp->employee_id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                  
                                       <a  data-toggle="modal" data-target="#exampleModal"   class="btn btn-info" onclick="view_employee('{{$emp->employee_id}}')" title="View">
                                          <i class="material-icons">visibility</i>
                                        </a>

                                     
                                       <a   href="{{ route('employee.edit', $emp) }}" class="btn btn-warning" title="Edit">
                                          <i class="material-icons">edit</i>
                                        </a>
                                  

                                       <a onclick="confirm('{{ __("Are you sure you want to delete this employee?") }}') ? this.parentElement.submit() : ''"  class="btn btn-danger" title="Delete">
          ...
          aria-hidden="true">
            <div class="modal-dialog modal-lg vertical-align-center">
              <div class="modal-content">
                ...
                <div class="modal-body">
                 ...
                 <form method="get" action="{{ url('filter_employee') }}" class="form-inline" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
            ...
            @method('get')
                 ...
                 <!-- <select class="form-control selectpicker" id="nationality" data-style="select-with-transition" name="nationality"  value="{{ old('nationality') }}">
                  ...
                  <input type="text" name="email_id" class="form-control" id="email_id" value="{{ old('email_id') }}" placeholder="Email ID">
                ...
                <div class="col-sm-4">
                 ...
                 <input type="text" name="emp_id" class="form-control" id="emp_id" value="{{ old('emp_id') }}" placeholder="Employee ID">
