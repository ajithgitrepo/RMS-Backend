...
@extends('layouts.app', ['activePage' => 'trade_stock_report', 'menuParent' => 'Outlets', 'titlePage' => __('Client Report')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Trade Stock Report') }}</h4>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      ...
                      @foreach($result as $report)
                        ...
                        <tr>
                          ...
                          <td>
                            {{ date('F', strtotime($report->expiry_date)) }} / {{ date('Y', strtotime($report->expiry_date)) }}
                          </td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <form method="post" action="{{ url('filter_trade_report') }}" class="form-inline" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
              @csrf
              @method('post')
              ...
              <div class="col-lg-4">
                 ...
                 <select class="form-control selectpicker" data-style="select-with-transition" title="Select Month" data-size="7" name="month" id="select-month" 
                     value="{{ old('month') }}" aria-required="true" multiple="multiple" >
               ...
               <div class="col-lg-4">
                 <input type="text" class="form-control" value="{{ $bar_code }}" id="bar_code" placeholder="Bar Code" name="bar_code">
               </div> 
