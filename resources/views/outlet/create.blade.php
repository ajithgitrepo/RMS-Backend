...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('outlet.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Add outlet') }}</h4>
               </div>
               ...
               <!--  <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('product') ? ' has-danger' : '' }}">
                     ...
                     value="{{ old('product') }}" aria-required="true" multiple="" >
                 ...
                 <div class="row">
                   <label class="col-sm-2 col-form-label">{{ __('Outlet Latitude') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('outlet_lat') ? ' has-danger' : '' }}">
                     
                    <input class="form-control{{ $errors->has('outlet_lat') ? ' is-invalid' : '' }}" name="outlet_lat" id="input-outlet_lat" type="text" placeholder="{{ __('') }}" value="{{ old('outlet_lat') }}"  aria-required="true"/>
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Outlet Longtitude') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('outlet_long') ? ' has-danger' : '' }}">
                     
                    <input class="form-control{{ $errors->has('outlet_long') ? ' is-invalid' : '' }}" name="outlet_long" id="input-outlet_long" type="text" placeholder="{{ __('') }}" value="{{ old('outlet_long') }}"  aria-required="true"/>
                  ...
                  <div class="row">
                   ...
                   <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('outlet_area') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('outlet_area') ? ' is-invalid' : '' }}" name="outlet_area" id="input-outlet_area" type="text" placeholder="{{ __('') }}" value="{{ old('outlet_area') }}"  aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('outlet_country') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('outlet_country') ? ' is-invalid' : '' }}" name="outlet_country" id="input-outlet_country" type="text" placeholder="{{ __('') }}" value="{{ old('outlet_country') }}"  aria-required="true"/>
