          ...
          <form method="post" action="{{ route('import') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="card ">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Import Outlet') }}</h4>
               </div>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                   <input class="form-control{{ $errors->has('outlet_import') ? ' is-invalid' : '' }}" type="file" name="outlet_import" multiple  >
                   
                    
                      @include('alerts.feedback', ['field' => 'outlet_import'])
