...
<style type="text/css">
 ...
 <link href="{{ asset('material') }}/dist/pie_chart/components.min.css" rel="stylesheet">
  ...
  <div class="content">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$total_employees}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$today_present}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$today_absent}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$total_field_managers}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$present_field_managers}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$absent_field_managers}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$total_merchandisers}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$present_merchandisers}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$absent_merchandiesers}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$SheduleCalls}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$UnSheduleCalls}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$SheduleCallsDone}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-warning card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$UnSheduleCallsDone}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$Attendance}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$WorkingTime}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$EffectiveTime}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$TravelTime}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$JourneyPlanpercentage}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$today_outlets}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$today_completed}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$today_pending}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$absent_merchandisers}}</h2>
              <h5 class="text-center" style="color: #827e7e;" >Absent Merchandisers</h5>
            </div>
          </div>
        </div>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$total_outlets}}</h2>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$completed_outlets}}</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h2 class="text-center" style="color: #827e7e;">{{$pending_outlets}}</h2>
            ...
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h3 class="text-left" style="color: #827e7e;" >Monthly Timesheet</h3>
                ...
                <div class="row justify-content-center" style="margin-bottom: 20px;">
                    <form method="post" action="{{ url('filter') }}" class="form-inline justify-content-center" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
                      @csrf
                      @method('post')
                    ...
                    <!--   <div class="col-lg-4">
                     ...
                     <div class="col-lg-6">
                       <!--  <input type="text" class="form-control " id="filter_result" placeholder="Filter By Result" name="filter_result"> -->
                        <select class="selectpicker" data-style="select-with-transition"  title="Select Merchandiser" data-size="7"  id="filter_result_field" name="filter_result" value="{{ old('filter_result') }}" style="width: 185px;">

                          <option value="">-- All --</option>

                        @foreach ($merchandisers as $emp)
                            <option value="{{$emp->employee_id}}" >  {{ $emp->first_name }} {{ $emp->middle_name ? $emp->middle_name : '' }} {{ $emp->surname ? $emp->surname : '' }} </option>
                        @endforeach
                    ...
                    <!--<div class="col-lg-2">
                       ...
                       <!-- <div class="col-lg-2">
                         <button type="submit"  class="btn btn-finish btn-fill btn-rose btn-wd" name="Filter" value="Filter">{{ __('Filter') }}</button>
              ...
              <h3 class="text-left" style="color: #827e7e;" >Monthly Timesheet</h3>
                ...
                <div class="row justify-content-center" style="margin-bottom: 20px;">
                    ...
                    <!--   <div class="col-lg-4">
                     ...
                     <div class="col-lg-6">
                       <!--  <input type="text" class="form-control " id="filter_result" placeholder="Filter By Result" name="filter_result"> -->
                        <select class="selectpicker" data-style="select-with-transition"  title="Select Merchandiser" data-size="7"  id="filter_result_cde" name="filter_result" value="{{ old('filter_result') }}" style="width: 185px;">
    ...
    <div class="row">
        ...
        <a href="/today_timesheet">
         ...
         <div class="col-lg-4 col-md-6 col-sm-6">
        <a href="/filter_today_timesheet?_token=5hnG63qBOOKh2hlX2RSheuIlybq66YCfT3WLTOnK&_method=get&status=1&startdate={{$date}}&enddate={{$date}}&Filter=Filter">
          <div class="card card-stats">
            <div class="card-header card-header-success card-header-icon">
              <div class="card-icon">
                <i class="material-icons">schedule</i>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
        <a href="/filter_today_timesheet?_token=5hnG63qBOOKh2hlX2RSheuIlybq66YCfT3WLTOnK&_method=get&status=0&startdate={{$date}}&enddate={{$date}}&Filter=Filter">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              <div class="card-icon">
                <i class="material-icons">schedule</i>
                  ...
                  <h3 class="text-left" style="color: #827e7e;" >Monthly Timesheet</h3>
                   ...
                   <div class="row justify-content-center" style="margin-bottom: 20px;">
                    ...
                    <!--   <div class="col-lg-4">
                     ...
                     <div class="col-lg-6">
                       <!--  <input type="text" class="form-control " id="filter_result" placeholder="Filter By Result" name="filter_result"> -->
                        <select class="selectpicker filter_by_admin" data-style="select-with-transition"  title="Select Field Manager" data-size="7"  id="filter_field_manager" name="filter_result_admin" value="{{ old('filter_result_admin') }}" style="width: 185px;">

                          <option value="">-- All --</option>

                        @foreach ($field_managers as $emp)
                            <option value="{{$emp->employee_id}}" >  {{ $emp->first_name }} {{ $emp->middle_name ? $emp->middle_name : '' }} {{ $emp->surname ? $emp->surname : '' }} </option>
                        @endforeach
                      ...
                      <div class="col-lg-6">
                       <!--  <input type="text" class="form-control " id="filter_result" placeholder="Filter By Result" name="filter_result"> -->
                        <select class="selectpicker filter_by_admin" data-style="select-with-transition"  title="Select Merchandiser" data-size="7"  id="filter_merchandiser" name="filter_result_admin" value="{{ old('filter_result_admin') }}" style="width: 185px;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table id="datatables_report"  class="table table-striped table-no-bordered table-hover" style="display:none" >
                                                ...
                                                @foreach($attendance as $merch)
                                                    <tr>
                                                        <td>{{$i++}}</td>
                                                        <td>{{$merch->first_name}} {{$merch->surname}}</td>
                                                        <td>{{$merch->merchandisers}}</td>
                                                        <td>{{$merch->present}}</td>
                                                        <td>{{($merch->merchandisers)-($merch->present)}}</td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
                        ...
                        <div class="table-responsive">
                            <table id="datatables"  class="table table-striped table-no-bordered table-hover" style="display:none" >
                                ...
                                @foreach($form as $for)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{$for->first_name}} {{$for->surname}}</td>
                                        <td>{{$for->num}}</td>
                                        <td>{{$for->checkin}}</td>
                                        <td>{{$for->checkout}}</td>
                                        <td>{{($for->num)-($for->checkin)}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{$total_stores}}</h2>
             ...
             <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{$total_products->count()}}</h2>
             ...
             <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{$total_outlets->count()}}</h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{ $total_scheduled_timesheet }}</h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{ $total_s_completed }}</h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{ $total_s_pending }}</h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{ $total_unscheduled_timesheet }}</h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{ $total_uns_completed }}</h2>
             ...
             <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h2 class="text-center" style="color: #827e7e;">{{ $total_uns_pending}}</h2>
                  ...
                  <h3 class="text-left" style="color: #827e7e;" >Monthly Timesheet</h3>
                   ...
                   <div class="row justify-content-center" style="margin-bottom: 20px;">
                    ...
                    <!--   <div class="col-lg-4">
                     ...
                     <div class="col-lg-6">
                       <!--  <input type="text" class="form-control " id="filter_result" placeholder="Filter By Result" name="filter_result"> -->
                        <select class="selectpicker" data-style="select-with-transition"  title="Select Field Manager" data-size="7"  id="filter_result" name="filter_result" value="{{ old('filter_result') }}" style="width: 185px;">
...
@endphp
      ...
      <input type="hidden" id="HidCheckCount" value={{$today_present}}>
  <!-- Modal -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
         <div class="row">
          ...
          <a id="BtnCheckin" href="{{ url('checkin') }}" class="btn btn-sm btn-success"><b>{{ __('Check In') }}</b></a>  
          <a id="BtnCheckout" href="{{ url('checkout') }}" class="btn btn-sm btn-danger"><b>{{ __('Check Out') }}</b></a>  
          </div>
          <div class="col-sm-6 text-left">        
          <a class="btn btn-sm btn-default" data-dismiss="modal" style="color:#FFFFFF"><b>{{ __('Ignore') }}</b></a>
          </div>
      </div>
    </div>
  </div>
