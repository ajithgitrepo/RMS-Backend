...
@extends('layouts.app', ['activePage' => 'admin_outlets_stockexpiry', 'menuParent' => 'Outlets', 'titlePage' => __('Overall Outlet Stock Report')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Overall Outlet Stock Report') }}</h4>
              </div>
              <div class="card-body">
                 ...
                 <div class="row">
                  ...
                  <!--  <div class="row">
                      <a id="export_stock1" onclick="export_stock1('xlsx')" style="color: #fff;" class="btn btn-sm btn-info ml-auto float-right" >Send To Approval</a>
                  </div>
                      ...
                      @foreach($result as $out)
                        ...
                        <tr>
                          ...
                          <td class=" td-actions display-block">
                               ...
                               <a  rel="tooltip" data-toggle="modal" data-target="#exampleModal"   class="btn btn-info" onclick="view_outletstock_report1('{{$out->id}}')" title="View">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <form method="post" action="{{ url('filter_overallstock_report') }}" class="form-inline" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
              @csrf
              @method('post')
                ...
                <div class="col-lg-3">
                    ...
                    <select class="form-control selectpicker" data-style="select-with-transition" title="Select Outlet" data-size="7" name="outlet_id" id="outlet_id" 
                     value="{{ old('outlet_id') }}" aria-required="true">
                      ...
                      <option value="{{ $outlet->outlet_id}}"> {{ $outlet->store[0]->store_code }} - {{ $outlet->store
...
@push('js')
  ...
  <script>
   ...
   //alert(data[0]); 
    ...
    function view_outletstock_report1(id){
      //alert(id);
      var csrf = $('meta[name="csrf-token"]').attr('content');
      $.ajax({
          url: '/view_outletstock1',
          type: 'GET',
          data: {id : id, '_token': csrf},
          dataType: 'json',
    ...
    function export_stock1(type){
         ...
         var date = $("#date").val();
          ...
          if (result.isConfirmed) {
            ...
            //$('#export_stock1').attr("disabled","disabled");

            $('#export_stock1').css("pointer-events","none");
          ...
          $.ajax({
              ...
              success: function( data ) {
                 ...
                 $("#mail_sending").hide();
                // alert(data);
                $('#export_stock1').css("pointer-events","auto");
