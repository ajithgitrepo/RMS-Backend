...
@extends('layouts.app', ['activePage' => 'today_timesheets', 'menuParent' => 'Live_Data', 'titlePage' => __('Live Data')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Today Timesheets') }}</h4>
              </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <form method="get" action="{{ url('filter_today_timesheet') }}" class="form-inline" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
              @csrf
              @method('get')
               ...
               <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                 <input type="text" style="float: left; margin-top: 30px;width: 344px;" class="datepicker" value="" id="startdate" placeholder="Start Date" name="startdate">
               </div> 

              
               
                <div class="col-lg-6">
                 <input type="text" style="float: left; margin-top: 30px;width: 344px;" class=" datepicker" value="" id="enddate" placeholder="End Date" name="enddate">
               </div> 
          ...
          dom: 'lBfrtip',
            ...
            buttons: [{
                ...
                filename: function(){
                    ...
                    return 'today_schedule_excel-' + dt;
                },
                //title: 'alpin_excel',
                exportOptions: {
                    modifier: {
