...
@extends('layouts.app', ['activePage' => 'total_timesheets', 'menuParent' => 'Live_Data', 'titlePage' => __('Live Data')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Total Timesheets') }}</h4>
              </div>

              <div class="card-body">

                 @canany(['isField_Manager','isAdmin','isTopManagement'],App\User::class)
                 <div class="row">
                ...
                @canany(['isField_Manager'],App\User::class)
                    <div class="row">
                        ...
                        <div class="col-12 text-right">
                          ...
                          <a href="{{ route('schedule-outlets.create') }}" class="btn btn-sm btn-rose">{{ __(' Add Scheduled Timesheet ') }}</a>
                ...
                <div class="table-responsive">
                    ...
                    <table id="datatables" class="table table-no-bordered">    
                        ...
                        @foreach($timesheets as $parent)
                            ...
                            <tr class="parent">
                             <!--  <td>
                               ...
                               <td>
                               {{ $parent->employee->first_name }} {{ $parent->employee->middle_name }} {{ $parent->employee->surname }} ({{ $parent->employee_id}})
                              </td>

                              @canany(['isAdmin','isTopManagement'],App\User::class)

                                @if(!empty($parent->employee_field))

                                    <td>
                                        {{ $parent->employee_field->first_name }} {{ $parent->employee_field->middle_name }} {{ $parent->employee_field->surname }} 
                                    </td>
                            ...
                            @endcan
                             ...
                             <td>
                                {{ $parent->store_code }}-{{ $parent->store_name }}-{{ $parent->address }}
                            </td>
                            ...
                            @if($parent->checkout_time && $parent->checkout_time )
                              <td>
                                @php
                        ...
                        <td class="td-actions">
                             ...
                             <form action="{{ route('schedule-outlets.destroy', $parent->id) }}" method="post">
                                  @csrf
                                  @method('delete')
                             
                                 <a onclick="confirm('{{ __("Are you sure you want to delete this timesheet?") }}') ? this.parentElement.submit() : ''" rel="tooltip" class="btn btn-danger" title="Delete">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <form method="get" action="{{ url('filter_total_timesheet') }}" class="form-inline" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
              @csrf
              @method('get')
               ...
               <div class="col-lg-6">
                 ...
                 <select class="form-control js-select2" data-style="select-with-transition" title="Select Merchandiser" data-size="7" name="employee_id" id="input-days" 
                     value="{{ old('employee_id') }}" aria-required="true" style="margin-bottom:10px;">
               ...
               <div class="col-lg-6">
                 ...
                 <select class="form-control js-select2" data-style="select-with-transition" title="Select Status" data-size="7" name="status" id="input-days" 
                     value="{{ old('status') }}" aria-required="true" style="margin-bottom:10px;">
                ...
                <div class="col-lg-6">
                 <input type="text" style="float: left; margin-top: 30px;width: 344px;" class="datepicker" value="{{ $startdate }}" id="startdate" placeholder="Start Date" name="startdate">
               </div> 

              
               
                <div class="col-lg-6">
                 <input type="text" style="float: left; margin-top: 30px;width: 344px;" class=" datepicker" value="{{ $enddate }}" id="enddate" placeholder="End Date" name="enddate">
               </div> 
          ...
          dom: 'lBfrtip',
            ...
            buttons: [{
                ...
                filename: function(){
                    ...
                    return 'total_schedule_excel-' + dt;
                },
                //title: 'alpin_excel',
                exportOptions: {
                    modifier: {
