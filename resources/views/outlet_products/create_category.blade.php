...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
           <form method="post" action="{{ route('outlet_categories', Request::segment(3)) }}" autocomplete="off" class="form-horizontal " enctype="multipart/form-data">
            @csrf
            @method('post')   
            ...
            <div class="row"> 
              <label class="col-sm-2 col-form-label">{{ __('NBL(Canvas)') }}</label>
              <div class="col-sm-5">
                <div class="form-group{{ $errors->has('outlet_name') ? ' has-danger' : '' }}">
              ...
              <div class="col-sm-3" style="margin-top: 10px;">
                    ...
                    <a href="/nbl_file/{{ $nbl_file[0]->file_url }}" target="_blank" >Click here to view uploaded NBL</a>
            ...
            <div class="row"> 
             ...
             <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Target And Planogram') }}</label>
                                 ...
                                 @if($old->planogram_img)
                                    ...
                                    <div class="col-lg-2">
                                        <div class="avatar avatar-sm " style="width:70px; height:70px;overflow: hidden;">
                                            ...
                                            <img id="" title="View" src="/planogram_image/{{ $old->planogram_img }}" onclick="DoSomething(this.src);" alt="" style="max-width: 70px;">
