...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <!-- <form method="post" action="{{ route('outlet-products.update', Request::segment(3)) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('put') -->
            ...
            <div class="card ">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Outlet Activities') }}</h4>
               </div>
                  ...
                  <div class="tab-pane active" id="link1">
                    ...
                    <div class="row">
                      <div class="col-md-12 text-right">
                        <a href="{{ route('add_outlet_categories',['id' => Crypt::encrypt(Request::segment(3)) ]) }}" class="btn btn-sm btn-rose">{{ __('Add Category & NBL') }}</a>
                  ...
                  <table id="datatables" class="table table-striped table-no-bordered table-hover datatable"  >
                    ...
                    <tbody id="availability_data">
                         ...
                         @foreach($old_category_data as $old_category)
                            ...
                            <!--   <td>
                                {{ $old_category->first_name }} {{ $old_category->middle_name }} {{ $old_category->surname }}
                              </td> -->
                              ...
                              <td>
                                   <div class="avatar avatar-sm " style="width:70px; height:70px;overflow: hidden;">
                                            ...
                                            <img id="" title="View" src="/planogram_image/{{ $old_category->planogram_img }}" onclick="DoSomething(this.src);" alt="" style="max-width: 70px;">
                           ...
                           <td class="td-actions">
                              <form action="{{ route('remove_outlet_categories', $old_category->id) }}" method="post">
                                @csrf
                                @method('post')
                                 
                              
                                   <a onclick="confirm('{{ __("Are you sure you want to delete this category?") }}') ? this.parentElement.submit() : ''" class="btn btn-danger" title="Delete">
