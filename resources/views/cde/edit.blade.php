...
@extends('layouts.app', ['activePage' => 'cde_user', 'menuParent' => 'Client', 'titlePage' => __('Edit CDE')])
    ...
    <div class="col-md-12 col-12 mr-auto ml-auto">
      ...
      <div class="wizard-container">
        <div class="card card-wizard" data-color="rose" id="wizardProfile">
           <form method="post" enctype="multipart/form-data" action="{{ route('cde.update', $employee[0]->employee_id) }}" autocomplete="off" 
             ...
             <input type="text" class="form-control" id="first_name" name="first_name" value="{{ old('first_name',$employee[0]->first_name) }}" required>
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-sm">
                        ...
                        <select class="form-control" id="nationality" name="nationality" value="{{ old('nationality') }}" name="country">
    <option value="Afghanistan"  @if ($employee[0]->nationality == "Afghanistan") {{ 'selected' }} @endif>Afghanistan</option>
    <option value="Aland Islands" @if ($employee[0]->nationality == "Aland Islands") {{ 'selected' }} @endif>Aland Islands</option>
        ...
        <option data-countryCode="ZW" value="263" @if ($employee[0]->codes == "263") {{ 'selected' }} @endif>Zimbabwe (+263)</option>
           ...
           @include('alerts.feedback', ['field' => 'mobile_number'])
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit"  class="btn btn-rose mx-auto">{{ __('Update CDE') }}</button>
              </div>
