...
@extends('layouts.app', ['activePage' => 'cde_user', 'menuParent' => 'Client', 'titlePage' => __('Add CDE')])
    ...
    <div class="col-md-12 col-12 mr-auto ml-auto">
      ...
      <div class="wizard-container">
        <div class="card card-wizard" data-color="rose" id="wizardProfile">
           <form method="post" enctype="multipart/form-data" action="{{ route('cde.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            <div class="card-header text-center">
              <h3 class="card-title">
                Build Profile for CDE
              </h3>
               <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('cde.index') }}" class="btn btn-sm btn-rose">{{ __('Back to list') }}</a>
                  </div>
                </div> 
            </div>
             <div class="card-body">
               ...
               <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-rose mx-auto">{{ __('Add CDE') }}</button>
               </div>
...
<script>
 ...
 // var countryUrl = "https://github.com/hampusborgos/country-flags/tree/main/svg/";
