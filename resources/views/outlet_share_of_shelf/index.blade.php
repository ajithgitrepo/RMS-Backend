...
@extends('layouts.app', ['activePage' => 'journey-plan', 'menuParent' => 'Journey-Plan', 'titlePage' => __('Journey Plan')])
                           ...
                           <div class="togglebutton">
                              <label>
                                ...
                                @if($check)
                                    ...
                                    <input type="checkbox" timesheet_id="{{$product->id}}" product_id="{{$product->product_id}}" outlet_id="{{$product->outlet_id}}" class="checkbox" checked="">
                                    @endif
                                    @if($product->is_available ==0)
                                    <input type="checkbox" timesheet_id="{{$product->id}}" product_id="{{$product->product_id}}" outlet_id="{{$product->outlet_id}}" class="checkbox" >
                                    @endif
                                @endif
