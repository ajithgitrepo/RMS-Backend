                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('brand_name') ? ' has-danger' : '' }}">
                     ...
                     <input class="form-control{{ $errors->has('brand_name') ? ' is-invalid' : '' }}" name="brand_name" id="input-brand_name" type="text" placeholder="{{ __('') }}" value="{{ old('brand_name')}}"  aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('promotion_type') ? ' has-danger' : '' }}">
                     ...
                     <input class="form-control{{ $errors->has('promotion_type') ? ' is-invalid' : '' }}" name="promotion_type" id="input-promotion_type" type="text" placeholder="{{ __('') }}" value="{{ old('promotion_type')}}"  aria-required="true"/>
                  ...
                  <div class="row">
                   ...
                   <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('mrp') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('mrp') ? ' is-invalid' : '' }}" name="mrp" id="input-mrp" type="text" placeholder="{{ __('') }}" value="{{ old('mrp') }}"  aria-required="true"/>
             ...
             <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    ...
                    <input class="form-control{{ $errors->has('visibility_type') ? ' is-invalid' : '' }}" name="visibility_type" id="input-visibility_type" type="text" placeholder="{{ __('') }}" value="{{ old('visibility_type')}}"  aria-required="true"/>
