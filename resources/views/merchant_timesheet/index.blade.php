...
@extends('layouts.app', ['activePage' => 'date-timesheet', 'menuParent' => 'Timesheet', 'titlePage' => __('Date JourneyPlan')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Date JourneyPlan') }}</h4>
              </div>
                      ...
                      <thead class="text-primary">
                        ...
                        @foreach($outlets as $parent)
                            ...
                            <tr class="parent">
                              ...
                              <!-- <td>
                               {{ $parent->outlet->outlet_lat }}
                              </td>
                              <td>
                                {{ $parent->outlet->outlet_long }}
                              </td> -->
                              <td>
                                {{ $parent->store_name }}
                              </td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <form method="get" action="{{ url('filter_merchant_timesheet') }}" class="form-inline" enctype="multipart/form-data" action="" autocomplete="off" style="text-align: right;">
              @csrf
              @method('get')
