@extends('layouts.app', ['activePage' => 'date-timesheet', 'menuParent' => 'Timesheet', 'titlePage' => __('UnScheduled Jouneyplan')])
          ...
          <form method="post" action="{{ route('merchant-timesheet.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="card ">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Add UnScheduled Jouneyplan') }}</h4>
              </div>
              <div class="card-body ">
                <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('merchant-timesheet.index') }}" class="btn btn-sm btn-rose">{{ __('Back to UnScheduled Jouneyplan') }}</a>
                  </div>
                </div>
