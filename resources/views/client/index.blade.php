...
@extends('layouts.app', ['activePage' => 'client', 'menuParent' => 'Client', 'titlePage' => __('client')])
                      ...
                      @foreach($employee as $emp)
                        ...
                        <tr>
                          ...
                          <td class=" td-actions display-block">
                              <form action="{{ route('client.destroy', $emp->employee_id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                  
                                      
                                     
                                       <a  rel="tooltip" href="{{ route('client.edit', $emp) }}" class="btn btn-warning" title="Edit">
