...
@extends('layouts.app', ['activePage' => 'client', 'menuParent' => 'Client', 'titlePage' => __('Edit Client')])
    ...
    <div class="col-md-12 col-12 mr-auto ml-auto">
      ...
      <div class="wizard-container">
        <div class="card card-wizard" data-color="rose" id="wizardProfile">
           <form method="post" enctype="multipart/form-data" action="{{ route('client.update', $employee[0]->employee_id) }}" autocomplete="off" 
        ...
        <option data-countryCode="ZW" value="263" @if ($employee[0]->codes == "263") {{ 'selected' }} @endif>Zimbabwe (+263)</option>
           ...
           @include('alerts.feedback', ['field' => 'mobile_number'])
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit"  class="btn btn-rose mx-auto">{{ __('Update Client') }}</button>
              </div>
