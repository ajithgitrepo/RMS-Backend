...
@extends('layouts.app', ['activePage' => 'client', 'menuParent' => 'Client', 'titlePage' => __('Add client')])
            ...
            <div class="card-header text-center">
             ...
             <div class="card-body">
                   ...
                   <div class="col-lg-10 mt-3">
                    ...
                    <div class="col-lg-10 mt-3">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group">
                          <label for="" class="bmd-label-floating">Middle Name(required)</label>
               ...
               <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-rose mx-auto">{{ __('Add Client') }}</button>
               </div>
