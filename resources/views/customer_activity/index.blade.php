    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
			  ...
			  @if($nbl_file->isNotEmpty())
            <a name="submit" href="/nbl_file/{{ $nbl_file[0]->file_url }} " target="_blank" id="check_out" class="btn btn-success " style="margin-bottom: 15px;color: #fff;">NBL File</a>
            @endif

            <button name="submit" id="check_out" class="btn btn-danger float-right"  value="{{Request::segment(2)}}" onclick="check_model(this.value)" style="margin-bottom: 15px;">Check Out</button>
             ...
             <!--  <div class="card-icon">
                <i class="material-icons">emoji_events</i>
                   ...
                   <h2 class="text-center" style="color: #827e7e;"><i class="material-icons">store_front</i></h2>
                    ...
                    <h5 class="text-center" style="color: #827e7e;" >{{ '[' .$result[0]->store_code. ']' }} {{ $result[0]->store_name .','}} {{ $result[0]->address .','}} {{ $result[0]->outlet_city .',' }} {{ $result[0]->outlet_state }} </h5>
            </div>
       ...
       <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats cards">
            <div class="card-header cards-header card-header-warning card-header-icon">
             <!--  <div class="card-icon">
              ...
              <a href="{{url('p-availabity',['id' => Crypt::encrypt(Request::segment(2)) ])}} "> 
         ...
         <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats cards">
            <div class="card-header cards-header card-header-warning card-header-icon">
             ...
             <a href="{{url('p-visibility',['id' => Crypt::encrypt(Request::segment(2)) ])}}"> <h5 class="text-center" style="color: #827e7e;" ><i class="material-icons">visibility</i>
         ...
         <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats cards">
           ...
           <a href="{{url('share_of_shelf',['id' => Crypt::encrypt(Request::segment(2)) ])}} ">  <h5 class=
            "text-center" style="color: #827e7e;" ><i class="material-icons">assessment</i>
                @if($shareof_shelf == true)
                <span class="material-icons" title="Completed" style="float:right;color: #3b9d40;">done</span>
                @endif
                @if($shareof_shelf == false)
                <span class="fa fa-times" title="Pending" style="float:right;color: red;"></span>
               @endif  
         ...
         <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats cards">
            <div class="card-header cards-header card-header-warning card-header-icon">
             ...
             <a href="{{url('promotion_check',['id' => Crypt::encrypt(Request::segment(2)) ])}}"> <h5 class="text-center" style="color: #827e7e;" ><i class="fa fa-percent"></i>

                 @if($promotion_check == true)
                <span class="material-icons" title="Completed" style="float:right;color: #3b9d40;">done</span>
                @endif
                @if($promotion_check == false)
                <span class="fa fa-times" title="Pending" style="float:right;color: red;"></span>
               @endif 
         ...
         <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats cards">
            <div class="card-header cards-header card-header-warning card-header-icon">
             ...
             <a href="{{url('p-planogramCheck',['id' => Crypt::encrypt(Request::segment(2)) ])}}"> <h5 class="text-center" style="color: #827e7e;" ><i class="material-icons">receipt_long</i>


                 @if($planogram_checks == true)
                <span class="material-icons" title="Completed" style="float:right;color: #3b9d40;">done</span>
                @endif
                @if($planogram_checks == false)
                <span class="fa fa-times" title="Pending" style="float:right;color: red;"></span>
               @endif  
        ...
        <!--  <div class="col-lg-6 col-md-6 col-sm-6">
         ...
         <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats cards">
            ...
            <a href="{{url('competitor_info',['id' => Crypt::encrypt(Request::segment(2)) ])}}"> <h5 class="text-center" style="color: #827e7e;" ><i class="material-icons">info</i>
         ...
         <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats cards">
            ...
            <a href="{{url('outlet_stockexpiry',['id' => Crypt::encrypt(Request::segment(2)) ])}}"> <h5 class="text-center" style="color: #827e7e;" ><i class="material-icons">insert_invitation</i>

                @if($outlet_stockexpiry == true)
                <span class="material-icons" title="Completed" style="float:right;color: #3b9d40;">done</span>
                @endif
                @if($outlet_stockexpiry == false)
                <span class="fa fa-times" title="Pending" style="float:right;color: red;"></span>
               @endif 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form method="post" action="{{ route('update_category_check') }} " autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
        ...
        <input  type="hidden" id="uploadvisibilityfile" name="uploadvisibilityfile[]"  />  
         <div class="col text-center">
            <button type="submit" value="{{ Request::segment(2) }}" id="update_category" class="btn btn-rose">Check Out</button>
          </div>
         </form>
    </div>
  </div>
